...
pro sophism_polmeas_modscheme_retardance,mmm_teo,mmm,tt1_teo,tt1
...
lcvr1amperr=(randomu(seed,1)+ampoff)*ampdif*info.reterrors(0)
lcvr1phaerr=(randomu(seed,1)+phaoff)*phadif*signpha*info.reterrors(1)
lcvr1angerr=(randomu(seed,1)+angoff)*angdif*signang*info.reterrors(2)

lcvr2amperr=(randomu(seed,1)+ampoff)*ampdif*info.reterrors(0)
signpha=randomu(seed,1)
if (signpha lt 0.5) then signpha=-1 else signpha=1
signang=randomu(seed,1)
if (signang lt 0.5) then signang=-1 else signang=1
lcvr2phaerr=(randomu(seed,1)+phaoff)*phadif*signpha*info.reterrors(1)
lcvr2angerr=(randomu(seed,1)+angoff)*angdif*signang*info.reterrors(2)
...
rett1=[info.retdeg1(0)+reterr1,info.retdeg1(1)+reterr1,info.retdeg1(2)+reterr2,info.retdeg1(3)+reterr2]
rett2=[info.retdeg2(0)+reterr3,info.retdeg2(1)+reterr4,info.retdeg2(2)+reterr5,info.retdeg2(3)+reterr6]

		; mod. state 1 
		lcvr1=transpose(device(amr=1.-lcvr1amperr,pha=rett1(0)+lcvr1phaerr,ang=ang1+lcvr1angerr))
		lcvr2=transpose(device(amr=1.-lcvr2amperr,pha=rett2(0)+lcvr2phaerr,ang=ang2+lcvr2angerr))
		...
		; mod. state 2 
		lcvr1=transpose(device(amr=1.-lcvr1amperr,pha=rett1(1)+lcvr1phaerr,ang=ang1+lcvr1angerr))
		lcvr2=transpose(device(amr=1.-lcvr2amperr,pha=rett2(1)+lcvr2phaerr,ang=ang2+lcvr2angerr))
		...
		; estado 3	
		lcvr1=transpose(device(amr=1.-lcvr1amperr,pha=rett1(2)+lcvr1phaerr,ang=ang1+lcvr1angerr))
		lcvr2=transpose(device(amr=1.-lcvr2amperr,pha=rett2(2)+lcvr2phaerr,ang=ang2+lcvr2angerr))
		...
		; estado 4 
		lcvr1=transpose(device(amr=1.-lcvr1amperr,pha=rett1(3)+lcvr1phaerr,ang=ang1+lcvr1angerr))
		lcvr2=transpose(device(amr=1.-lcvr2amperr,pha=rett2(3)+lcvr2phaerr,ang=ang2+lcvr2angerr))
